    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="{{ asset('assets/index2.html') }}" class="navbar-brand"><b>Payroll </b>System</a>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                ...
                <li class="{{ Request::segment(1) == 'positions' ? 'active' : ''}}"><a href="{{route('positions.index')}}">Position</a></li>
                <li class="{{ Request::segment(1) == 'workcycles' ? 'active' : ''}}"><a href="{{route('workcycles.index')}}">Work Cycle</a></li>
              </ul>
            </li>
          </ul>
